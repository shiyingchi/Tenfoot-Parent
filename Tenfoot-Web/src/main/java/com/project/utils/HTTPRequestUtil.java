...
public class HTTPRequestUtil {
     ...
     * @throws Exception
     */
    public static String doPostFile(String filePath, String url,String key,String token) throws Exception {
        ...
        try {
            ...
            HttpEntity reqEntity = MultipartEntityBuilder.create()
                    ...
                    .addPart("key",new StringBody(key, ContentType.create("text/plain", Consts.UTF_8)))//相当于<input type="file" name="media"/>
                    .addPart("token", new StringBody(token, ContentType.create("text/plain", Consts.UTF_8)))//相当于<input type="file" name="media"/>
                    .build();
